...
<head>
  <!-- ... -->
  <script type="text/javascript" src="/bower_componen/jquery/jquery.min.js"></script>
  <script type="text/javascript" src="/bower_componen/moment/min/moment.min.js"></script>
  <script type="text/javascript" src="/bower_componen/bootstrap/dist/js/bootstrap.min.js"></script>
  <script type="text/javascript" src="/bower_componen/eonasdan-bootstrap-datetimepicker/build/js/bootstrap-datetimepicker.min.js"></script>
  <link rel="stylesheet" href="/bower_componen/bootstrap/dist/css/bootstrap.min.css" />
  <link rel="stylesheet" href="/bower_componen/eonasdan-bootstrap-datetimepicker/build/css/bootstrap-datetimepicker.min.css" />
</head>
```
## Nuget
